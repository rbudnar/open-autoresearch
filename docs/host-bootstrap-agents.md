...
If you are changing the `open-autoresearch` repository itself, stop here and
read the root [`AGENTS.md`](../AGENTS.md) plus [`docs/dogfooding.md`](./dogfooding.md).
This guide is only for one-shot host-repo bootstrap.
